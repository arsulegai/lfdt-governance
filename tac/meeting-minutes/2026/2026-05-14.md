...
- [Rethv](https://github.com/LF-Decentralized-Trust-labs/LF-Decentralized-Trust-labs.github.io/pull/393) - experimental fork of Reth that replaces the Ethereum Virtual Machine execution with a RISC-V virtual machine; merged on May 11, 2026
...
- ADOPTERS.md going forward — awaiting connection with Tomas for input from end-user perspective.
